function calculateSimpleInterest() {
    ...
    simpleInterestResultElement.textContent = `Simple Interest: $${simpleInterest.toFixed(2)}`;
  }
  ...
  function calculateCompoundInterest() {
    ...
    compoundInterestResultElement.textContent = `Compound Interest: $${compoundInterest.toFixed(2)}`;
  }
